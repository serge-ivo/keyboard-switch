APP_NAME = KeyboardSwitch
APP_DISPLAY_NAME = Keyboard Switch
APP_BUNDLE = $(APP_DISPLAY_NAME).app
OLD_APP_BUNDLE = KeyboardMonitor.app
APP_INFO_PLIST = Info.plist
INSTALL_DIR = /Applications
PLIST_NAME = com.serge.keyboardswitch.plist
OLD_PLIST_NAME = com.serge.keyboardmonitor.plist
...
PKG_IDENTIFIER = com.serge.keyboardswitch.pkg
...
clean:
	rm -rf .build "$(APP_NAME)" KeyboardMonitor "$(APP_BUNDLE)" "$(OLD_APP_BUNDLE)" "$(PROMPT_APP_BUNDLE)" $(DIST_DIR)
